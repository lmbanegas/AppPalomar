...
for (let index = 0; index < mesesCortados.length; index++) {
    console.log(JSON.stringify(mesesCortados[index].desde.dia + "/" + mesesCortados[index].desde.mes + "/" + mesesCortados[index].desde.anio + " al " + mesesCortados[index].hasta.dia + "/" +  mesesCortados[index].hasta.mes + "/" +mesesCortados[index].hasta.anio + ": $"  +   mesesCortados[index].haber.toFixed(2) + " - OS: " + mesesCortados[index].os.toFixed(2) + " -  Tiempo: " + mesesCortados[index].proporcionalMeses.toFixed(4)  
...
for (let i = 0; i < nuevosMesesAguinaldo.length; i++ ) {
console.log(JSON.stringify(nuevosMesesAguinaldo[i].desde.dia + "/" + nuevosMesesAguinaldo[i].desde.mes +  "/" +nuevosMesesAguinaldo[i].desde.anio + " al " + nuevosMesesAguinaldo[i].hasta.dia + "/" + nuevosMesesAguinaldo[i].hasta.mes +  "/" + nuevosMesesAguinaldo[i].hasta.anio + ": $" + nuevosMesesAguinaldo[i].haber.toFixed(2) + " - OS: $" + nuevosMesesAguinaldo[i].os.toFixed(2)))}
