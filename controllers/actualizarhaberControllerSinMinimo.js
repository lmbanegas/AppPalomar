...
const pensionControllerSinMinimo = {
    inicioPension: (req, res) => {
        res.render('actualizarHaberSinMinimo', { nuevosMesesAguinaldo: [], mesesCortados: [], datos: [], retroHaberFinal: 0, retroOsFinal: 0, retroDevOsFinal: 0, aguinaldo: 0, aguinaldoOs: 0, aguinaldoDevOs: 0, neto: 0 })
    },
    calcularPension: (req, res) => {
        ...
        haberBruto = parseFloat(sumatoria);
        obraSocial = (((haberBruto * 0.06)));

        if (obraSocial > mesesCortados[0].os) {
...
module.exports = pensionControllerSinMinimo;
