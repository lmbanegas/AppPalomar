...
const pensionControllerSinMinimo = {
    inicioPension: (req, res) => {
        res.render('pensionCargaSinMinimo', { nuevosMesesAguinaldo: [], mesesCortados: [], datos: [], retroHaberFinal: 0, retroOsFinal: 0, retroDevOsFinal: 0, aguinaldo: 0, aguinaldoOs: 0, aguinaldoDevOs: 0, neto: 0 })
    },
